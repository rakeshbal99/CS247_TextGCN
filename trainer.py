...
class PrepareData:
    def __init__(self, args):
        print("prepare data")
        if args.opti_type == "truncate":
            self.graph_path = "data/graph_eff"
        elif args.opti_type == "window":
            self.graph_path = "data/graph_eff_window"
        elif args.opti_type == "docu_only":
...
def main(dataset, times, opti_type):
    args = parameter_parser()
    args.dataset = dataset
    args.opti_type = opti_type
...
if __name__ == '__main__':
    ...
    for d in ["mr", "ohsumed", "R52", "R8", "20ng"]:
        for opti_type in ["orig", "truncate", "docu_only", "window"]:
            print(d, opti_type)
            main(d, 1, opti_type)
    # main("ohsumed")
    # main("R8", 1)
